...
type OrderServiceClient interface {
	...
	GetAllOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderResponseList, error)
}
...
func (c *orderServiceClient) GetAllOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderResponseList, error) {
...
type OrderServiceServer interface {
	...
	GetAllOrders(context.Context, *Blank) (*OrderResponseList, error)
...
func (UnimplementedOrderServiceServer) GetAllOrders(context.Context, *Blank) (*OrderResponseList, error) {
